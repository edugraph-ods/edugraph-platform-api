...
from app.features.authentication.application.internal.inbound_services.uses_cases.get_student_use_case import \
...
from app.features.authentication.infrastructure.persistence.sql_alchemist.repositories.student_repository_impl import \
    StudentRepositoryImpl
from app.features.authentication.infrastructure.persistence.sql_alchemist.repositories.user_repository_impl import \
    UserRepositoryImpl
from app.features.authentication.interfaces.rest.schemas.student_profile_response import StudentProfileResponse
